...
namespace TensorSharp.Expression
{
    ...
    public abstract class VariableExpression
    {
        ...
        public abstract NDArray Evaluate(NDArray writeTarget);
    }
    ...
    public class ViewExpression : VariableExpression
    {
        ...
        /// The evaluate
        /// </summary>
        private readonly Func<NDArray, NDArray> evaluate;
    ...
    public class FromArrayExpression : VariableExpression
    {
        ...
        public override NDArray Evaluate(NDArray writeTarget)
        {
            ...
            {
                return NDArray.FromArray(allocator, array);
            }
        }
    }
    ...
    public class AsTypeExpression : VariableExpression
    {
        ...
        public override NDArray Evaluate(NDArray writeTarget)
        {
            using (var srcVal = src.Evaluate(null))
            {
                if (writeTarget == null)
                {
                    writeTarget = new NDArray(srcVal.Allocator, type, srcVal.Shape);
                }
    ...
    public class ToDeviceExpression : VariableExpression
    {
        ...
        public override NDArray Evaluate(NDArray writeTarget)
        {
            using (var srcVal = src.Evaluate(null))
            {
                if (writeTarget == null)
                {
                    writeTarget = new NDArray(allocator, srcVal.ElementType, srcVal.Shape);
                }
    ...
    public class FillExpression : VariableExpression
    {
        ...
        /// The fill action
        /// </summary>
        private readonly Action<NDArray> fillAction;
        ...
        public FillExpression(IAllocator allocator, DType elementType, long[] sizes, Action<NDArray> fillAction)
        {
            this.allocator = allocator;
        ...
        {
            if (writeTarget == null)
                writeTarget = new NDArray(allocator, elementType, sizes);
    ...
    public class TensorValueExpression : VariableExpression
    {
        ...
        /// The value
        /// </summary>
        private readonly NDArray value;

        /// <summary>
        /// Initializes a new instance of the <see cref="TensorValueExpression"/> class.
        /// </summary>
        /// <param name="value">The value.</param>
        public TensorValueExpression(NDArray value)
            : base(true)
        {
            this.value = value;
        }
    ...
    public class BinaryTensorTensorExpression : VariableExpression
    {
        ...
        /// The evaluate
        /// </summary>
        private readonly Func<NDArray, NDArray, NDArray, NDArray> evaluate;
        ...
        /// <param name="evaluate">The evaluate.</param>
        public BinaryTensorTensorExpression(VariableExpression left, VariableExpression right, Func<NDArray, NDArray, NDArray, NDArray> evaluate)
        {
            this.left = left;
            this.right = right;
            this.evaluate = evaluate;
    ...
    public class UnaryTensorExpression : VariableExpression
    {
        ...
        /// The evaluate
        /// </summary>
        private readonly Func<NDArray, NDArray, NDArray> evaluate;
    ...
    public class BinaryScalarTensorExpression : VariableExpression
    {
        ...
        /// The evaluate
        /// </summary>
        public readonly Func<NDArray, float, NDArray, NDArray> evaluate;
        ...
        /// <param name="right">The right.</param>
        /// <param name="evaluate">The evaluate.</param>
        public BinaryScalarTensorExpression(ScalarExpression left, VariableExpression right, Func<NDArray, float, NDArray, NDArray> evaluate)
        {
            this.left = left;
            this.right = right;
            this.evaluate = evaluate;
    ...
    public class BinaryTensorScalarExpression : VariableExpression
    {
        ...
        /// The evaluate
        /// </summary>
        public readonly Func<NDArray, NDArray, float, NDArray> evaluate;
