...
namespace TensorSharp.CUDA.MatrixMul
{
    ...
    public static class CudaMatrixMulMM
    {
        ...
        private static void GemmOp(TSCudaContext context, BlasOp transA, BlasOp transB, float alpha, NDArray a, NDArray b, float beta, NDArray c)
        {
        ...
        /// </exception>
        public static NDArray Mul_M_M(TSCudaContext context, NDArray result, NDArray lhs, NDArray rhs)
        {
