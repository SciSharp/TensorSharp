...
namespace TensorSharp.CUDA
{
    ...
    public static class CudaHelpers
    {
        ...
        public static CUdeviceptr GetBufferStart(NDArray tensor)
        {
        ...
        public static int GetDeviceId(NDArray tensor)
        {
        ...
        public static TSCudaContext TSContextForTensor(NDArray tensor)
        {
