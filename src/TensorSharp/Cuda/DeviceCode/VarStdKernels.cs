...
";
        ...
        private NDArray RunVarOp(NDArray result, NDArray src, int dimension, bool normByN, bool applySqrt)
        {
        ...
        /// <param name="normByN">if set to <c>true</c> [norm by n].</param>
        /// <returns>Tensor.</returns>
        public NDArray Var(NDArray result, NDArray src, int dimension, bool normByN)
        {
        ...
        /// <param name="normByN">if set to <c>true</c> [norm by n].</param>
        /// <returns>Tensor.</returns>
        public NDArray Std(NDArray result, NDArray src, int dimension, bool normByN)
        {
