...
";
        ...
        private void ReduceIndexOuterDim(TSCudaContext context, NDArray resultValues, NDArray resultIndices, NDArray src, int dimension, Tuple<float, float> init, string baseKernelName)
        {
        ...
        /// <param name="init">The initialize.</param>
        /// <param name="baseKernelName">Name of the base kernel.</param>
        private void ReduceIndexInnermostDim(TSCudaContext context, NDArray resultValues, NDArray resultIndices, NDArray src, Tuple<float, float> init, string baseKernelName)
        {
            var cudaContext = context.CudaContextForTensor(src);
        ...
        private NDArray RunReduceIndexOp(NDArray resultIndices, NDArray src, int dimension, Tuple<float, float> init, string baseKernelName)
        {
            ...
            using (var resultValueBuffer = new NDArray(src.Allocator, src.ElementType, requiredOutputSize))
            {
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns>Tensor.</returns>
        public NDArray ArgMin(NDArray result, NDArray src, int dimension)
        {
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns>Tensor.</returns>
        public NDArray ArgMax(NDArray result, NDArray src, int dimension)
        {
