...
namespace TensorSharp.CUDA.KernelOps
{
    ...
    public static class ApplyOpInvoke
    {
        ...
        {
            foreach (var tensor in args.OfType<NDArray>())
            {
    ...
    public static class ElementwiseTTOp
    {
        ...
        public static NDArray Invoke(ElementwiseKernels kernels, string funcName, NDArray result, NDArray src)
        {
    ...
    public static class ElementwiseTTSOp
    {
        ...
        /// <returns>Tensor.</returns>
        public static NDArray Invoke(ElementwiseKernels kernels, string funcName, NDArray result, NDArray src, float value)
        {
            var context = CudaHelpers.TSContextForTensor(src);
            var cudaContext = context.CudaContextForTensor(src);
    ...
    public static class Atan2Op
    {
        ...
        /// <returns>Tensor.</returns>
        public static NDArray Invoke(ElementwiseKernels kernels, NDArray result, NDArray srcY, NDArray srcX)
        {
