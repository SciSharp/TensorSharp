...
namespace TensorSharp.Cpu
{
    ...
    public static class SpatialConvolutionMM
    {
        ...
        /// </exception>
        public static void Conv2BackwardInput(NDArray input, NDArray gradOutput, NDArray gradInput, NDArray weight, NDArray finput, NDArray fgradInput, ConvolutionDesc2d cd)
        {
            var nOutputPlane = weight.Shape[0];
