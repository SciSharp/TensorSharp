...
namespace TensorSharp
{
    ...
    public class NDArray : IDisposable
    {
        ...
        public NDArray(long[] sizes, long[] strides, Storage storage, long storageOffset)
        {
            this.shape = sizes;
            this.strides = strides;
        ...
        public NDArray RepeatTensor(params long[] repetitions)
        {
            ...
            var result = new NDArray(this.Allocator, this.ElementType, resultSize);
        ...
        /// <param name="array">The array.</param>
        /// <returns>Tensor.</returns>
        public static NDArray FromArray(IAllocator allocator, Array array)
        {
            ...
            var result = new NDArray(allocator, elementType, dimSizes);
        ...
        /// <param name="stream">The stream.</param>
        /// <returns>Tensor.</returns>
        public static NDArray Deserialize(IAllocator allocator, System.IO.Stream stream)
        {
        ...
        public static NDArray Arange(IAllocator allocator, float start, float stop, int step = 1)
        {
            NDArray result = null;
            ...
            result = new NDArray(allocator, DType.Float32, 1, data.Count);
        ...
        public NDArray AsType(DType elementType)
        {
        ...
        public static NDArray operator +(NDArray lhs, float rhs) { return TOps.Add(lhs, rhs); }

        public static NDArray operator +(float lhs, NDArray rhs) { return TOps.Add(rhs, lhs); }
        ...
        public static NDArray operator -(NDArray lhs, float rhs) { return TOps.Sub(lhs, rhs); }

        public static NDArray operator -(float lhs, NDArray rhs) { return TOps.Sub(lhs, rhs); }
        ...
        public static NDArray operator /(NDArray lhs, float rhs) { return TOps.Div(lhs, rhs); }

        public static NDArray operator /(float lhs, NDArray rhs) { return TOps.Div(rhs, lhs); }

        public static NDArray operator >(NDArray lhs, NDArray rhs) { return TOps.GreaterThan(lhs, rhs); }
        ...
        public static NDArray operator >=(NDArray lhs, NDArray rhs) { return TOps.GreaterOrEqual(lhs, rhs); }
